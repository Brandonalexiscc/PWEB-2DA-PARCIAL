...
// Ruta para eliminar personas del registro
...
router.post('/deletePersons', (req, res) =>{
...
router.get('/updatePerson/:id', (req, res) => {
...
//Ruta para buscar a una persona en el formulario
router.post('/find', (req, res) =>{
    Person.find({nombre: {$regex: req.body.criteria, $options: "i" } })
    .then((persons) => {res.render('person', {persons})})
    .catch((err) => {res.json({message:err})});
});
